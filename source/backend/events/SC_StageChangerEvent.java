 ...
 */
public class SC_ChangeStageEvent extends ScriptedSongEvent
{
  private void new()
  {
    super("ChangeStage");
   ...
   */
  override private void handleEvent(SongEventData data)
  {
    ModuleHandler.getModule("SC_StageChanger").scriptCall("swapStage", [data.value.stageid, null]);
  }

  private void getEventSchema()
  {
    return new ArrayList<Map<String, Object>>() { { add(new HashMap<String, Object>() { { put("name", "stageid"); put("title", "Stage"); put("defaultValue", "mainStage"); put("type", "enum"); put("keys", new HashMap<String, Object>() { { ; } }); } }); } };
  }
   ...
   */
  static private void generateStageList() StringMap<String, String>
  {
    var Array stageIDs<String> = StageRegistry.instance.listEntryIds();
    var StringMap stageMap<String, String> = new StringMap();

...
public class HScriptCallSongEvent extends ScriptedSongEvent {
    public HScriptCallSongEvent() {
        super("HScript Call");
    }

    @Override
    public void handleEvent(Object data) {
        // Lógica para chamar a função no HScript
        // Geralmente envolve pegar o functionName e args do data
    }
    ...
    public List<Map<String, Object>> getEventSchema() {
        return new ArrayList<Map<String, Object>>() {{
            add(new HashMap<String, Object>() {{
                put("name", "functionName");
                put("title", "Function Name");
                put("defaultValue", "");
                put("type", "string");
            }});
            add(new HashMap<String, Object>() {{
                put("name", "args");
                put("title", "Arguments (JSON)");
                put("defaultValue", "");
                put("type", "string");
            }});
        }};

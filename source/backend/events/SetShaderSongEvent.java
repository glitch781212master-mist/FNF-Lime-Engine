...
public class SetShaderSongEvent extends ScriptedSongEvent
{
	public SetShaderSongEvent()
	{
		super("Set Shader");
	}
	...
	//TODO: make this more interesting, allow for setting more shaders w/ value adjustment. this selection kinda sucks i just grabbed a few randos
	//also add additional functionality to objects the shaders can be set on. might not be as possible
	public void getEventSchema()
	{
		return new ArrayList<Map<String, Object>>() { { add(new HashMap<String, Object>() { { put("name", "target"); put("title", "Target"); put("defaultValue", 0); put("type", "enum"); put("keys", new HashMap<String, Object>() { { put("Game Camera (Multiple Shaders)", 0); put("HUD Camera (Multiple Shaders)", 1); put("Cutscene Camera (Multiple Shaders)", 2); put("Opponent (One Shader)", 10); put("Player (One Shader)", 11); put("Girlfriend (One Shader)", 12); } }); } }); add(new HashMap<String, Object>() { { put("name", "shader"); put("title", "Shader"); put("defaultValue", "NONE"); put("type", "enum"); put("keys", new HashMap<String, Object>() { { put("None", "NONE"); put("Invert", "InvertColorShader"); put("Mosaic", "MosaicEffect"); put("Grayscale", "Grayscale"); put("Gaussian Blur", "GaussianBlurShader"); put("Inverse Dots", "InverseDotsShader"); } }); } }); add(new HashMap<String, Object>() { { put("name", "clear"); put("title", "Clear other shaders"); put("defaultValue", false); put("type", "bool"); } }); } };
	}
}
...
public class PlaySoundSongEvent extends ScriptedSongEvent {
	public PlaySoundSongEvent() {
		super("playSound");
	}
	...
	public void getEventSchema() {
		return new ArrayList<Map<String, Object>>() { { add(new HashMap<String, Object>() { { put("name", "fileName"); put("title", "File Name"); put("defaultValue", ""); put("type", "string"); put("units", ".ogg"); } }); add(new HashMap<String, Object>() { { put("name", "volume"); put("title", "Volume"); put("defaultValue", 1); put("type", "float"); } }); } };
	}
}
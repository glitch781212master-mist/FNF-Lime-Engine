...
public class ChangeCharacterEvent extends ScriptedSongEvent {
    ...
    public void handleEvent(data) {
        ...
        CharacterDataParser.characterCache.h[CharacterDataParser.characterCache.h.size()+1] = charData;
	...
	public void getEventSchema() {
		return new ArrayList<Map<String, Object>>() { { add(new HashMap<String, Object>() { { put("name", "character"); put("title", "Old Character"); put("defaultValue", "bf"); put("type", "enum"); put("keys", new HashMap<String, Object>() { { put("boyfriend", "bf"); put("girlfriend", "gf"); put("dad", "dad"); } }); } }); add(new HashMap<String, Object>() { { put("name", "newchar"); put("title", "New Character (JSON)"); put("defaultValue", "bf"); put("type", "string"); } }); } };
	}

...
public class HealthDrainEvent extends ScriptedSongEvent {
    ...
    Save.instance.modOptions.set("HealthDrain", data.value.enable);
    Save.instance.flush();
}

	public void getEventSchema() {
		return new ArrayList<Map<String, Object>>() { { add(new HashMap<String, Object>() { { put("name", "enable"); put("title", "Enable"); put("defaultValue", true); put("type", "bool"); } }); } };
	}

	public void getTitle() {
		return "Health Drain Event";
	}
	
	public HealthDrainEvent() {
		super("HealthDrainEvent");
	}
}
...
public class FadeInOutSongEvent extends ScriptedSongEvent {
	public FadeInOutSongEvent() {
		super("FadeInOut");
	}
	...
	public void getEventSchema() {
		return new ArrayList<Map<String, Object>>() { { add(new HashMap<String, Object>() { { put("name", "inout"); put("title", "Fade"); put("defaultValue", 0); put("type", "enum"); put("keys", new HashMap<String, Object>() { { put("In", 0); put("Out", 1); } }); } }); add(new HashMap<String, Object>() { { put("name", "object"); put("title", "Object"); put("defaultValue", 0); put("type", "enum"); put("keys", new HashMap<String, Object>() { { put("Black Screen", 0); put("UI", 1); put("Subtitles", 2); } }); } }); add(new HashMap<String, Object>() { { put("name", "seconds"); put("title", "Duration"); put("defaultValue", 0); put("type", "float"); put("units", "seconds"); } }); } };
	}
}
...
public class AdjustStagePropSongEvent extends ScriptedSongEvent {
	public AdjustStagePropSongEvent() {
		super("AdjustStageProp");
	}
	...
	public void getTitle() {
		return "Adjust Stage Prop";
	}

	public void getEventSchema() {
		return new ArrayList<Map<String, Object>>() { { add(new HashMap<String, Object>() { { put("name", "propName"); put("title", "Stage Prop Name"); put("defaultValue", ""); put("type", "string"); } }); add(new HashMap<String, Object>() { { put("name", "alpha"); put("title", "Alpha"); put("defaultValue", 1); put("type", "float"); } }); add(new HashMap<String, Object>() { { put("name", "duration"); put("title", "Duration"); put("defaultValue", 0); put("type", "float"); put("units", "seconds"); } }); } };
	}
}